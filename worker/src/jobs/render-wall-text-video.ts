...
function getFinalLayout(value: Json, contentLayoutVersion: Json | undefined) {
  ...
  const isArialBoldV11RolloutEnvelope =
    contentLayoutVersion === "wall-text-overlay-v11" &&
    layout.version === "wall-text-final-layout-v4";
  const isArialBoldV12RolloutEnvelope =
    contentLayoutVersion === "wall-text-overlay-v12" &&
    layout.version === "wall-text-final-layout-v4";
  const isArialBoldV10RolloutEnvelope =
  ...
  if (
    ...
    (layout.version === "wall-text-final-layout-v9" || layout.version === "wall-text-final-layout-v8" || layout.version === "wall-text-final-layout-v7" || layout.version === "wall-text-final-layout-v6"
      ...
      : layout.version === "wall-text-final-layout-v4"
        ? layout.fontFamily !== "Arial" || Number(layout.fontWeight) !== WALL_TEXT_ARIAL_REGULAR_FONT_WEIGHT
  ...
  if (
    ...
    throw new Error("text.finalLayout V2/V3/V4/V5/V6/V7/V8/V9 must contain one 4-8 line text block.");
  }
  ...
  if (isArialBoldV12RolloutEnvelope || layout.version === "wall-text-final-layout-v8") {
    return {
      blocks,
      fontFamily: "Arial" as const,
      fontSizePx,
  ...
  if (isArialBoldV11RolloutEnvelope || layout.version === "wall-text-final-layout-v7") {
    return {
      blocks,
      fontFamily: "Arial" as const,
      fontSizePx,
  ...
  if (isArialBoldV10RolloutEnvelope || layout.version === "wall-text-final-layout-v6") {
    return {
      blocks,
      fontFamily: "Arial" as const,
      fontSizePx,
