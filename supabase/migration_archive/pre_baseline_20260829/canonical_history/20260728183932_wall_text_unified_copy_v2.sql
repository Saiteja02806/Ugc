alter table public.wall_text_creatives
  alter column generator_version
    set default 'business-profile-wall-text-v2',
...
revoke all on function public.replace_wall_text_creative_copy_v2(
  text,
  uuid,
  integer,
  text,
...
grant execute on function public.replace_wall_text_creative_copy_v2(
  text,
  uuid,
  integer,
  text,
