...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    dailyContentPieces: "20/day for 3 days",
    instagramAccounts: 1,
    capacityLabel: "3-day trial: 20 daily concepts and unlimited Instagram scheduling",
    features: [
      "No credit card required",
      "20 ready-to-post pieces daily for 3 days",
      "Unlimited Instagram scheduling during the 3-day trial",
