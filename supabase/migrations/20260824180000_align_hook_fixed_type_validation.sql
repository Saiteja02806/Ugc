-- The fixed-type worker release emits V4 validator and overlay provenance.
-- Keep V3 valid during a rolling deployment, while requiring validator and
-- overlay versions to advance as a matching pair.
