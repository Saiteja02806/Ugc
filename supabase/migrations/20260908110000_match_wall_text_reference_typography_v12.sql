-- V12 preserves the measured five-to-eight-line Arial Bold 700 contract while
-- recording the compact 44px, crisp 3px-outline, no-shadow reference treatment.
-- Existing V11/V10 rows remain valid and keep their persisted rendering style.
do $$
declare
  v_constraint_definition text;
  v_constraint_tail constant text := ', false))';
  v_arial_bold_v12_branch constant text := $wall_text_v12$
 or (
  text_content ->> 'layoutVersion' = 'wall-text-overlay-v12'
  ...
  and text_content -> 'finalLayout' ->> 'version' = 'wall-text-final-layout-v8'
