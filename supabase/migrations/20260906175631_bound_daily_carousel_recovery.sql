-- Keep automatic Carousel recovery finite across fresh physical job IDs.
...
begin
  ...
  if v_existing.replacement_sequence >= 3 then return null; end if;
...
begin
  ...
  if found then
    ...
    if v_batch.replacement_sequence >= 3
