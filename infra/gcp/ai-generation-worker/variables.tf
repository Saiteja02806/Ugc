...
variable "worker_job_types" {
  ...
  type        = string
  default     = "generate_avatar,generate_image,generate_hook_video,generate_trending_hook_copy,hook_text_generation,wall_text_generation,media_analysis,analytics_sync,carousel_content_plan_generation"
}
