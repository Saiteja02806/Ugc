-- Keep Instagram connection limits authoritative even when multiple OAuth
-- callbacks arrive concurrently. Existing active connections are not deleted
-- or blocked from refreshing their credentials after a plan downgrade.
