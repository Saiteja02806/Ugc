-- Keep historical Wall records readable while allowing the lighter,
-- measured V8 treatment to be stored and re-laid out safely.

alter table public.wall_text_creatives
  alter column generator_version
    set default 'business-profile-wall-text-v8';
...
revoke all on function public.replace_wall_text_creative_copy_v8(
  text,
  uuid,
  integer,
  text,
...
grant execute on function public.replace_wall_text_creative_copy_v8(
  text,
  uuid,
  integer,
  text,
