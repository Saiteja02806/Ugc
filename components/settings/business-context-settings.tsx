  ...
  return (
    <div className="flex flex-col gap-6 px-5 py-5 sm:px-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="Wall-of-Text primary reader" className="sm:col-span-2"><Input value={context.wallTextPrimaryReader ?? ""} placeholder="The main reader category Wall-of-Text should speak to" onChange={(event) => updateTextField("wallTextPrimaryReader", event.target.value)} /></Field>
        <Field label="Wall-of-Text secondary reader (optional)" className="sm:col-span-2"><Input value={context.wallTextSecondaryReader ?? ""} placeholder="A distinct second reader category, when the business supports one" onChange={(event) => updateTextField("wallTextSecondaryReader", event.target.value)} /></Field>
